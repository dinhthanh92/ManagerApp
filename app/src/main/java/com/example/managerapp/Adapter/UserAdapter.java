...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.viewHover> {
            ...
            public void onClick(View v) {
                ...
                alertDialogBuilder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ApiService.apiService.ResetPassword().enqueue(new Callback<ApiResponseResult<Object>>() {
                            @Override
    ...
    public static class viewHover extends RecyclerView.ViewHolder {
        ...
        viewHover(View view){
            ...
            this.statusView = (CheckBox) view.findViewById(R.id.value_status_view_user);
